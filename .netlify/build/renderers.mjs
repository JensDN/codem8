...
import { g as AstroUserError, A as AstroError } from './chunks/astro/assets-service_CNprl8SU.mjs';
import { A as AstroJSX, e as renderJSX, f as createVNode } from './chunks/astro/server_DJkfMIdL.mjs';
...
async function renderToStaticMarkup$1(Component, props, { default: children, ...slotted }, metadata) {
	...
	if (children && opts.experimentalReactChildren) {
		...
		const convert = await import('./chunks/vnode-children_DqDjcVGe.mjs').then((mod) => mod.default);
