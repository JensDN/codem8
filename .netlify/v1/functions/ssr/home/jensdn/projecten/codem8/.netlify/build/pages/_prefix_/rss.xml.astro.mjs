import { o as objectType, a as stringType, u as unionType, n as numberType, d as dateType, b as arrayType, r as recordType, f as functionType, p as promiseType, c as anyType, e as preprocessType, h as booleanType, i as config, j as getBlogEntries, k as context, l as getPathWithBase } from '../../chunks/content_BP_MmZgA.mjs';
import { y as yellow } from '../../chunks/astro/server_DJkfMIdL.mjs';
import { _ as _Renderer, M as Marked, d, N } from '../../chunks/swap_C1mAwM4_.mjs';
import { B, F } from '../../chunks/index_hpDd0Hk8.mjs';
...
function o(i = {}) {
  ...
  let a = [];
  return Object.getOwnPropertyNames(_Renderer.prototype).forEach((e) => {
...
const markedText = new Marked({ gfm: true }, o());
...
async function renderMarkdownToHTML(markdown, link) {
...
function getRSSStaticPaths() {
  return [{ params: { prefix: config.prefix } }];
}
async function getRSSOptions(site) {
...
const GET = async ({ site }) => {
  return getRssResponse(await getRSSOptions(site));
};
